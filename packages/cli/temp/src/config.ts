...
export default {
    ...
    */
    ...
    //                 let user = await ctx.mvcContext.getContainer().resolve({ token: UserService, regify: true })
    ...
    //             return ctx.mvcContext.getContainer().resolve({ token: UserService, regify: true }).findById(obj.data);
    //         }
    //     ]
    // },
